...
class BrasilianismoCrawler(scrapy.Spider):
    name = 'brasilianismoCrawler'
    start_urls = ['https://brasilianismo.blogosfera.uol.com.br/']
...
process.crawl(BrasilianismoCrawler)
process.start()